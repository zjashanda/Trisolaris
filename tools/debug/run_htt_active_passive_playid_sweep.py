...
CASES: list[SweepCase] = [
    ...
    full_chain_case("FULL-BRIGHT-MAX-001", "最亮全链路", "fixed-passive", "灯光调到最亮", 0x0057, 0x0048),
    ...
    full_chain_case("FULL-ROD1-DOWN-001", "杆一下降全链路", "fixed-passive", "杆一下降", 0x0053, 0x0064),
